...
class CryptoComTicker(TickerData):
    ...
    def init_data(self) -> CryptoComTicker:
        ...
        self.last_price = from_dict_get_float(data, "a")
        self.bid_price = from_dict_get_float(data, "b")
        self.ask_price = from_dict_get_float(data, "k")
        self.high_24h = from_dict_get_float(data, "h")
        self.low_24h = from_dict_get_float(data, "l")
        self.volume_24h = from_dict_get_float(data, "v")
        self.quote_volume_24h = from_dict_get_float(data, "vv")
